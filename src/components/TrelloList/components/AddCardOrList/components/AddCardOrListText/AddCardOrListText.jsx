...
const AddCardOrListText = () => {
  return (
    <div className="add-card-or-list-title">
        <label>
            <textarea className="add-card-or-list-title-textarea" type="text" placeholder="Enter a title for this card..."></textarea>
        </label>
        <div className="add-card-or-list-buttons">
          <button className="add-card-or-list-button">Añadir Tarjeta</button>
